# ex264: Crie uma função que receba uma string como parâmetro e retorne a string fatiada pelos 150 primeiros caracteres e no fim um "Leia Mais" se houver mais que 150 caracteres.
